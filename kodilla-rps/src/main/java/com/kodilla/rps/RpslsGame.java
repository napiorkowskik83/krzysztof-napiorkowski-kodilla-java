...
public class RpslsGame {
    ...
    public boolean playNextRound() {
        ...
        String computerMove = options.get(randomGenerator.nextInt(5));

        if ("1".equals(choice) || "2".equals(choice) || "3".equals(choice)
                || "4".equals(choice) || "5".equals(choice)) {
    ...
    public void checkWinner(int userMoveInt, int computerMoveInt) {
        if (1 == userMoveInt && 2 == computerMoveInt) {
            ...
            player.addWin();
        } else if (1 == userMoveInt && 4 == computerMoveInt) {
            System.out.println("Your move: " + moves.get(userMoveInt - 1));
            System.out.println("Computer's move: " + moves.get(computerMoveInt - 1));
            System.out.println(moves.get(userMoveInt - 1) + " crushes " + moves.get(computerMoveInt - 1));
            System.out.println("You won this round!");
            player.addWin();
        } else if (1 == userMoveInt && 5 == computerMoveInt) {
            System.out.println("Your move: " + moves.get(userMoveInt - 1));
            System.out.println("Computer's move: " + moves.get(computerMoveInt - 1));
            System.out.println(moves.get(computerMoveInt - 1) + " crushes " + moves.get(userMoveInt - 1));
            System.out.println("Computer won this round!");
            computer.addWin();
            ...
            System.out.println("Computer won this round!");
            computer.addWin();
        } else if (2 == userMoveInt && 4 == computerMoveInt) {
            System.out.println("Your move: " + moves.get(userMoveInt - 1));
            System.out.println("Computer's move: " + moves.get(computerMoveInt - 1));
            System.out.println(moves.get(computerMoveInt - 1) + " eats " + moves.get(userMoveInt - 1));
            System.out.println("Computer won this round!");
            computer.addWin();
        } else if (2 == userMoveInt && 5 == computerMoveInt) {
            System.out.println("Your move: " + moves.get(userMoveInt - 1));
            System.out.println("Computer's move: " + moves.get(computerMoveInt - 1));
            System.out.println(moves.get(userMoveInt - 1) + " proofs mistake of " + moves.get(computerMoveInt - 1));
            System.out.println("You won this round!");
            player.addWin();
            ...
            System.out.println("Your move: " + moves.get(userMoveInt - 1));
            System.out.println("Computer's move: " + moves.get(computerMoveInt - 1));
            System.out.println(moves.get(userMoveInt - 1) + " cut " + moves.get(computerMoveInt - 1));
            System.out.println("You won this round!");
            player.addWin();
        } else if (3 == userMoveInt && 4 == computerMoveInt) {
            System.out.println("Your move: " + moves.get(userMoveInt - 1));
            System.out.println("Computer's move: " + moves.get(computerMoveInt - 1));
            System.out.println(moves.get(userMoveInt - 1) + " wounds " + moves.get(computerMoveInt - 1));
            System.out.println("You won this round!");
            player.addWin();
        } else if (3 == userMoveInt && 5 == computerMoveInt) {
            System.out.println("Your move: " + moves.get(userMoveInt - 1));
            System.out.println("Computer's move: " + moves.get(computerMoveInt - 1));
            System.out.println(moves.get(computerMoveInt - 1) + " breaks " + moves.get(userMoveInt - 1));
            System.out.println("Computer won this round!");
            computer.addWin();
        } else if (4 == userMoveInt && 1 == computerMoveInt) {
            System.out.println("Your move: " + moves.get(userMoveInt - 1));
            System.out.println("Computer's move: " + moves.get(computerMoveInt - 1));
            System.out.println(moves.get(computerMoveInt - 1) + " crushes " + moves.get(userMoveInt - 1));
            System.out.println("Computer won this round!");
            computer.addWin();
        } else if (4 == userMoveInt && 2 == computerMoveInt) {
            System.out.println("Your move: " + moves.get(userMoveInt - 1));
            System.out.println("Computer's move: " + moves.get(computerMoveInt - 1));
            System.out.println(moves.get(userMoveInt - 1) + " eats " + moves.get(computerMoveInt - 1));
            System.out.println("You won this round!");
            player.addWin();
        } else if (4 == userMoveInt && 3 == computerMoveInt) {
            System.out.println("Your move: " + moves.get(userMoveInt - 1));
            System.out.println("Computer's move: " + moves.get(computerMoveInt - 1));
            System.out.println(moves.get(computerMoveInt - 1) + " wounds " + moves.get(userMoveInt - 1));
            System.out.println("Computer won this round!");
            computer.addWin();
        } else if (4 == userMoveInt && 5 == computerMoveInt) {
            System.out.println("Your move: " + moves.get(userMoveInt - 1));
            System.out.println("Computer's move: " + moves.get(computerMoveInt - 1));
            System.out.println(moves.get(userMoveInt - 1) + " poisons " + moves.get(computerMoveInt - 1));
            System.out.println("You won this round!");
            player.addWin();
        } else if (5 == userMoveInt && 1 == computerMoveInt) {
            System.out.println("Your move: " + moves.get(userMoveInt - 1));
            System.out.println("Computer's move: " + moves.get(computerMoveInt - 1));
            System.out.println(moves.get(userMoveInt - 1) + " crushes " + moves.get(computerMoveInt - 1));
            System.out.println("You won this round!");
            player.addWin();
        } else if (5 == userMoveInt && 2 == computerMoveInt) {
            System.out.println("Your move: " + moves.get(userMoveInt - 1));
            System.out.println("Computer's move: " + moves.get(computerMoveInt - 1));
            System.out.println(moves.get(computerMoveInt - 1) + " proofs mistake of " + moves.get(userMoveInt - 1));
            System.out.println("Computer won this round!");
            computer.addWin();
        } else if (5 == userMoveInt && 3 == computerMoveInt) {
            System.out.println("Your move: " + moves.get(userMoveInt - 1));
            System.out.println("Computer's move: " + moves.get(computerMoveInt - 1));
            System.out.println(moves.get(userMoveInt - 1) + " breaks " + moves.get(computerMoveInt - 1));
            System.out.println("You won this round!");
            player.addWin();
        } else if (5 == userMoveInt && 4 == computerMoveInt) {
            System.out.println("Your move: " + moves.get(userMoveInt - 1));
            System.out.println("Computer's move: " + moves.get(computerMoveInt - 1));
            System.out.println(moves.get(computerMoveInt - 1) + " poisons " + moves.get(userMoveInt - 1));
            System.out.println("Computer won this round!");
            computer.addWin();
        } else {
            if (1 == userMoveInt) {
